...
const ItemActionButton = ({
  ...
  <button
    ...
    onClick={onClick}
    disabled={disabled}
    className={`flex h-7 items-center gap-1 rounded-[6.75px] bg-[#F6F7F9] px-[8.75px] text-[10px] font-medium disabled:cursor-not-allowed disabled:opacity-50 sm:text-xs ${className}`}
  >
