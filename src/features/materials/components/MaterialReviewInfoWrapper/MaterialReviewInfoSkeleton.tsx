    ...
    <div aria-busy="true" aria-label="Loading material reviews" className="space-y-6">
      <div className="space-y-4">
        ...
        <div className="flex flex-wrap items-start justify-between gap-6">
          <div className="w-full min-w-72.5 max-w-197.75 space-y-6">
          ...
          <div className="w-full min-w-72.5 max-w-96.75 space-y-6">
            <div className="space-y-4 rounded-[8px] bg-[#F6F7F9] p-4">
            ...
            <div className="space-y-3 rounded-[8px] bg-[#F6F7F9] p-4">
      ...
      <div className="space-y-6 bg-[#F6F7F9] p-4 sm:p-10">
        <div className="space-y-4">
